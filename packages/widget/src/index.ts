...
class CradleCharacter extends HTMLElement {
  ...
  private render() {
    this.shadow.innerHTML = [
      ...
      '.panel{position:absolute;bottom:100%;right:12px;margin-bottom:12px;width:min(380px,calc(100vw - 32px));max-height:calc(100vh - 140px);overflow-y:auto;box-sizing:border-box;scrollbar-width:thin;display:flex;flex-direction:column;align-items:flex-end;gap:8px;background:transparent;box-shadow:none;border:0;padding:0 2px 2px 0}.panel[hidden]{display:none}.panel ::slotted(*){align-self:stretch;width:100%;box-sizing:border-box}',
