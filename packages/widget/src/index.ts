...
class CradleCharacter extends HTMLElement {
  ...
  private render() {
    this.shadow.innerHTML = [
      ...
      '</style>',
      '<div class="shell"><section class="panel" hidden aria-label="Website character"><strong class="title">Loading...</strong><p class="greeting">Connecting to companion...</p></section><button class="trigger" type="button" aria-label="Open website character" aria-expanded="false"><span class="companion" aria-hidden="true"></span></button></div>',
